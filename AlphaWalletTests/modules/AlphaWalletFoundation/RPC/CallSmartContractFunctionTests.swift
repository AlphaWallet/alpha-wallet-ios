...
class CallSmartContractFunctionTests: XCTestCase {
    ...
    func testEventLogCachingKey() {
        ...
        let sendCachingKey = GetEventLogs.generateEventLogCachingKey(contractAddress: contractAddress, eventName: eventName, abiString: abiString, filter: sendFilter)
        let receiveCachingKey = GetEventLogs.generateEventLogCachingKey(contractAddress: contractAddress, eventName: eventName, abiString: abiString, filter: receiveFilter)
