...
//Duplicated from RequestViewController.swift for easier upstream merging
//Careful to fit in shorter phone like iPhone 5s without needing to scroll
class AlphaWalletRequestViewController: UIViewController {
	...
	let viewModel: AlphaWalletRequestViewModel

	init(
			viewModel: AlphaWalletRequestViewModel
	) {
