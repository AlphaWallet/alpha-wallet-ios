...
//Duplicated from LockCreatePasscodeViewController.swift for easier upstream merging
class AlphaWalletLockCreatePasscodeViewController: AlphaWalletLockPasscodeViewController {
