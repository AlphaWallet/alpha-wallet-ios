...
//Duplicated from SettingsViewController.swift for easier upstream merging
class AlphaWalletSettingsViewController: FormViewController {
    ...
    override func viewDidLoad() {
        ...
        <<< AlphaWalletSettingsSwitchRow {
            ...
            $0.value = AlphaWalletSettingsViewController.isPushNotificationEnabled
        }.onChange { [unowned self] row in
        ...
        <<< AppFormAppearance.alphaWalletSettingsButton { row in
            ...
            row.presentationMode = .show(controllerProvider: ControllerProvider<UIViewController>.callback {
                let vc = AlphaWalletAdvancedSettingsViewController(account: account, config: self.config)
                vc.delegate = self
...
extension AlphaWalletSettingsViewController: AlphaWalletAdvancedSettingsViewControllerDelegate {
