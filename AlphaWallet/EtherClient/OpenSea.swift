...
class OpenSea {
    ...
    static func isServerSupported(_ server: RPCServer) -> Bool {
        ...
        case .main, .rinkeby:
            return true
        case .kovan, .ropsten, .poa, .sokol, .classic, .callisto, .custom, .goerli, .xDai, .artis_sigma1, .artis_tau1, .binance_smart_chain, .binance_smart_chain_testnet:
            return false
        }
    }
    ...
    private func getBaseURLForOpensea() -> String {
        ...
        case .kovan, .ropsten, .poa, .sokol, .classic, .callisto, .xDai, .goerli, .artis_sigma1, .artis_tau1, .binance_smart_chain, .binance_smart_chain_testnet, .custom:
            return Constants.openseaAPI
        }
    }
