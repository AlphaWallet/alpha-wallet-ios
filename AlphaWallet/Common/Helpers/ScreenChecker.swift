...
extension ScreenChecker {
    ...
    public static func size(old: CGFloat? = nil, big: CGFloat, medium: CGFloat, small: CGFloat) -> CGFloat {
        return AlphaWallet.Device.size(old: old, small: small, medium: medium, big: big)
    }
}
