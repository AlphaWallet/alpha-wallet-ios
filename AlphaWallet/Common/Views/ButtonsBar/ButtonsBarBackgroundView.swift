...
class ButtonsBarBackgroundView: UIView {
    ...
    init(buttonsBar: ButtonsBarViewType,
         edgeInsets: UIEdgeInsets = DataEntry.Metric.ButtonsBar.insets,
         separatorHeight: CGFloat = DataEntry.Metric.ButtonsBar.separatorHeight) {
