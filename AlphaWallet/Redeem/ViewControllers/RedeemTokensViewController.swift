//
//  RedeemTokensViewController.swift
//  Alpha-Wallet
//
...
protocol RedeemTokensViewControllerDelegate: class {
...
class RedeemTokensViewController: UIViewController, TokenVerifiableStatusViewController {
    ...
    var viewModel: RedeemTokensViewModel
    weak var delegate: RedeemTokensViewControllerDelegate?

    init(config: Config, token: TokenObject, viewModel: RedeemTokensViewModel) {
        self.config = config
        self.token = token
    ...
    func configure(viewModel newViewModel: RedeemTokensViewModel? = nil) {
    ...
    func nextButtonTapped() {
        ...
        if selectedTokenHolders.isEmpty {
            UIAlertController.alert(title: "",
                                    message: R.string.localizable.aWalletTokenTokenRedeemSelectTokensAtLeastOneTitle(),
...
extension RedeemTokensViewController: UITableViewDelegate, UITableViewDataSource {
...
extension RedeemTokensViewController: BaseTokenListFormatTableViewCellDelegate {
