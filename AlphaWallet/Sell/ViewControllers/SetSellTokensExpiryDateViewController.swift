...
protocol SetSellTokensExpiryDateViewControllerDelegate: class {
...
class SetSellTokensExpiryDateViewController: UIViewController, TokenVerifiableStatusViewController {
    ...
    var viewModel: SetSellTokensExpiryDateViewControllerViewModel
    var paymentFlow: PaymentFlow
    var TokenHolder: TokenHolder
    var ethCost: String
    weak var delegate: SetSellTokensExpiryDateViewControllerDelegate?
    ...
    init(
            ...
            ethCost: String,
            viewModel: SetSellTokensExpiryDateViewControllerViewModel
    ) {
        self.config = config
    ...
    @objc func nextButtonTapped() {
        ...
        guard expiryDate > Date() else {
            UIAlertController.alert(title: "",
                    message: R.string.localizable.aWalletTokenTokenSellLinkExpiryTimeAtLeastNowTitle(),
    ...
    func configure(viewModel newViewModel: SetSellTokensExpiryDateViewControllerViewModel? = nil) {
...
extension SetSellTokensExpiryDateViewController: DateEntryFieldDelegate {
...
extension SetSellTokensExpiryDateViewController: TimeEntryFieldDelegate {
