...
protocol SellTokensViewControllerDelegate: class {
...
class SellTokensViewController: UIViewController, TokenVerifiableStatusViewController {
    ...
    var viewModel: SellTokensViewModel
    var paymentFlow: PaymentFlow
    weak var delegate: SellTokensViewControllerDelegate?

    init(config: Config, paymentFlow: PaymentFlow, viewModel: SellTokensViewModel) {
        self.config = config
    ...
    func configure(viewModel newViewModel: SellTokensViewModel? = nil) {
    ...
    func nextButtonTapped() {
        ...
        if selectedTokenHolders.isEmpty {
            UIAlertController.alert(title: "",
                                    message: R.string.localizable.aWalletTokenTokenSellSelectTokensAtLeastOneTitle(),
...
extension SellTokensViewController: UITableViewDelegate, UITableViewDataSource {
...
extension SellTokensViewController: BaseTokenListFormatTableViewCellDelegate {
