...
class SecureEnclave {
    ...
    func encrypt(plainTextData: Data, withPublicKeyFromLabel name: String) throws -> Data {
        let privateKey: SecKey
        do {
            privateKey = try getPrivateKey(withName: name)
        } catch {
    ...
    func decrypt(cipherText: Data, withPrivateKeyFromLabel name: String) throws -> Data {
        let privateKey = try getPrivateKey(withName: name)
