...
protocol TransferTokensQuantitySelectionViewControllerDelegate: class {
...
class TransferTokensQuantitySelectionViewController: UIViewController, TokenVerifiableStatusViewController {
    ...
    var viewModel: TransferTokensQuantitySelectionViewModel
    var paymentFlow: PaymentFlow
    private let token: TokenObject
    weak var delegate: TransferTokensQuantitySelectionViewControllerDelegate?

    init(
            config: Config = Config(),
            paymentFlow: PaymentFlow,
            token: TokenObject,
            viewModel: TransferTokensQuantitySelectionViewModel
    ) {
        self.config = config
    ...
    func nextButtonTapped() {
        if quantityStepper.value == 0 {
            UIAlertController.alert(title: "",
                                    message: R.string.localizable.aWalletTokenTokenTransferSelectTokenQuantityAtLeastOneTitle(),
    ...
    func configure(viewModel newViewModel: TransferTokensQuantitySelectionViewModel? = nil) {
