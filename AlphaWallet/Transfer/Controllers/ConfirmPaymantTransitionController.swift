//
//  ConfirmPaymantTransitionController.swift
//  AlphaWallet
//
...
class ConfirmPaymantTransitionController: NSObject {

    //NOTE: Need to retain self until dismissal because UIKit won't.
    private var selfRetainer: ConfirmPaymantTransitionController? = nil
...
extension ConfirmPaymantTransitionController: UIViewControllerTransitioningDelegate {
