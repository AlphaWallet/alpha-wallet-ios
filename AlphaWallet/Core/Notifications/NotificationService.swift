...
public final class NotificationService {
    ...
    init(sources: [NotificationSourceService], walletBalanceService: WalletBalanceService, notificationService: ScheduledNotificationService, pushNotificationsService: PushNotificationsService) {
