...
protocol ChainStateSchedulerProviderDelegate: AnyObject {
    func didReceive(result: Result<Int, PromiseError>)
}

final class ChainStateSchedulerProvider: SchedulerProvider {
    ...
    weak var delegate: ChainStateSchedulerProviderDelegate?
