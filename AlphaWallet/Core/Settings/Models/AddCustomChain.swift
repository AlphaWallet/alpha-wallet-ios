...
enum AddCustomChainError: LocalizedError {
    case cancelled
...
class AddCustomChain {
    ...
    init(_ customChain: WalletAddEthereumChainObject, analytics: AnalyticsLogger, isTestnet: Bool, restartQueue: RestartTaskQueue, url: URL?, operation: SaveOperationType, chainNameFallback: String) {
...
extension AddCustomChain.functional {
    ...
    static func checkAndDetectUrls(_ customChain: WalletAddEthereumChainObject, chainId: Int, analytics: AnalyticsLogger, chainNameFallback: String) -> Promise<(customChain: WalletAddEthereumChainObject, chainId: Int, rpcUrl: String)> {
