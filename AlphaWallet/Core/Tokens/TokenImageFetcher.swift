...
class RPCServerImageFetcher {
    ...
    func image(server: RPCServer, iconImage: UIImage) -> Subscribable<Image> {
...
class TokenImageFetcher {
    ...
    private func getDefaultOrGenerateIcon(server: RPCServer, contractAddress: AlphaWallet.Address, type: TokenType, name: String, tokenImage: UIImage?, colors: [UIColor], staticOverlayIcon: UIImage?, blockChainNameColor: UIColor) -> TokenImage? {
        switch type {
        case .nativeCryptocurrency:
    ...
    func image(contractAddress: AlphaWallet.Address, server: RPCServer, name: String, type: TokenType, balance: NonFungibleFromJson?, size: GoogleContentSize, contractDefinedImage: UIImage?, colors: [UIColor], staticOverlayIcon: UIImage?, blockChainNameColor: UIColor) -> Subscribable<TokenImage> {
        ...
        let generatedImage = getDefaultOrGenerateIcon(server: server, contractAddress: contractAddress, type: type, name: name, tokenImage: contractDefinedImage, colors: colors, staticOverlayIcon: staticOverlayIcon, blockChainNameColor: blockChainNameColor)
        if contractAddress.sameContract(as: Constants.nativeCryptoAddressInDatabase) {
