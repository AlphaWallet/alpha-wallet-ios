...
extension UniswapERC20Token {
    ...
    static func isSupport(token: TokenObject) -> Bool {
        ...
        case .kovan, .ropsten, .rinkeby, .sokol, .goerli, .artis_sigma1, .artis_tau1, .custom, .poa, .callisto, .xDai, .classic, .binance_smart_chain, .binance_smart_chain_testnet, .heco, .heco_testnet, .taiChi:
            return false
        }
    }
