...
class ImportTokenViewController: UIViewController, OptionalTokenVerifiableStatusViewController {
    enum State {
        case ready(ImportTokenViewControllerViewModel)
        case notReady
    }
    ...
    private var viewModel: ImportTokenViewControllerViewModel?
    var contract: String? {
        didSet {
    ...
    init(config: Config) {
        ...
        NSLayoutConstraint.activate([
            ...
            statusLabel.widthAnchor.constraint(equalTo: TokenView.widthAnchor, constant: -20),
    ...
    func configure(viewModel: ImportTokenViewControllerViewModel) {
        ...
        if let viewModel = self.viewModel {
            ...
            TokenView.configure(viewModel: .init())

            TokenView.isHidden = !viewModel.showTokenRow

            TokenView.stateLabel.isHidden = true

            TokenView.TokenCountLabel.text = viewModel.TokenCount
            TokenView.venueLabel.text = viewModel.venue
            TokenView.dateLabel.text = viewModel.date
            TokenView.cityLabel.text = viewModel.city
            TokenView.categoryLabel.text = viewModel.category
            TokenView.timeLabel.text = viewModel.time
            TokenView.teamsLabel.text = viewModel.teams
            TokenView.matchLabel.text = viewModel.match

            TokenView.dateImageView.isHidden = !viewModel.showTokenRowIcons
            TokenView.seatRangeImageView.isHidden = !viewModel.showTokenRowIcons
            TokenView.categoryImageView.isHidden = !viewModel.showTokenRowIcons
