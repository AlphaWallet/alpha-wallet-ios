...
class LockPasscodeViewController: UIViewController {
	...
	private func configureNavigationItems() {
		navigationItem.rightBarButtonItem = UIBarButtonItem(title: R.string.localizable.cancel(preferredLanguages: Languages.preferred()), style: .plain, target: self, action: #selector(userTappedCancel))
	}
