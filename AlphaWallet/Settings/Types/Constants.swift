...
public struct Constants {
    ...
    // fee master
    public static let paymentServer = "https://app.awallet.io:8443/api/claimToken"
    public static let getTicketInfoFromServer = "https://app.awallet.io:8443/api/ecrecoverAndGetTickets"
