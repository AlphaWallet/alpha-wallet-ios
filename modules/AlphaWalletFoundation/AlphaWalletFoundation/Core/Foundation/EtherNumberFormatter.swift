...
extension EtherNumberFormatter {
    ...
    public static func createShortEtherNumberFormatter() -> EtherNumberFormatter {
    ...
    public static func createShortPlainEtherNumberFormatter() -> EtherNumberFormatter {
        let formatter = EtherNumberFormatter(locale: Config.locale)
        formatter.maximumFractionDigits = Constants.etherFormatterFractionDigits
...
public final class EtherNumberFormatter {
    ...
    public static var short: EtherNumberFormatter = .createShortEtherNumberFormatter()

    public static var shortPlain: EtherNumberFormatter = .createShortPlainEtherNumberFormatter()
    ...
    public init(locale: Locale = Config.locale) {
        self.locale = locale
